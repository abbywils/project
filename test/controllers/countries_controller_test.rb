...
class CountriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create country" do
    assert_difference('Country.count') do
      post countries_url, params: { country: { region: @country.region, states_name: @country.states_name } }
    end
  ...
  test "should update country" do
    patch country_url(@country), params: { country: { region: @country.region, states_name: @country.states_name } }
